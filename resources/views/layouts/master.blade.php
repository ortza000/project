                        ...
                        <nav class="navbar navbar-collapse navbar-fixed-top" role="navigation">
                            <div class="container">
                                <div class="navbar-header">
                                    ...
                                    <h1 class="logo"><a class="navbar-brand" href="index.html"><img
                                                src="img/logobuu2.png" alt="">เว็บเทคโนโลยีสารสนเทศ</a></h1>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 wow fadeInRight">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h3 class="media-heading"><a href="#"> 1</a></h3>
                                                <h3 class="media-heading"><a href="#"> คอมพิวเตอร์ 2559</a></h3>
                                    ...
                                    <div class="col-md-6 wow fadeInRight">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h3 class="media-heading"><a href="#"> 2</a></h3>
                                                <h3 class="media-heading"><a href="#"> อบรม ทักษะเขียนโปรเเกรม</a></h3>
                                                <a href="register_coruse.php?course_id=2"><input type="submit"
                                                        method="get" value="อ่านข่าวนี้" class="btn btn-primary"></a>
                                            </div> <!-- /.media-body -->
                                        </div> <!-- /.media -->
                                    </div> <!-- /.col-md-6 -->
                                    ...
                                    <div class="col-md-6 wow fadeInRight">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h3 class="media-heading"><a href="#"> 3</a></h3>
                                                <h3 class="media-heading"><a href="#"> sssss</a></h3>
                                                <a href="register_coruse.php?course_id=3"><input type="submit"
                                                        method="get" value="อ่านข่าวนี้" class="btn btn-primary"></a>
                                            </div> <!-- /.media-body -->
                                        </div> <!-- /.media -->
                                    </div> <!-- /.col-md-6 -->
                                    ...
                                    <div class="col-md-6 wow fadeInRight">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h3 class="media-heading"><a href="#"> 4</a></h3>
                                                <h3 class="media-heading"><a href="#"> asdasdg</a></h3>
                                                <a href="register_coruse.php?course_id=4"><input type="submit"
                                                        method="get" value="อ่านข่าวนี้" class="btn btn-primary"></a>
                                            </div> <!-- /.media-body -->
                                        </div> <!-- /.media -->
                                    </div> <!-- /.col-md-6 -->
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="footer-widget">
                                        <p class="subcsribe-text wow fadeInDown">Quickly utilize installed base channels
                                            before premier expertise. Conveniently extend web-enabled niche markets
                                            without 2.0 e-markets. Collaboratively incentivize .</p>
                                ...
                                <div class="col-md-12">
                                    <div class="copyright wow fadeInDown">
                                        <p>Copyright &copy; 2016 primex . All Rights Reserved. Designed by <a
                                                href="http://www.uicookies.com/">uicookies.com</a> </p>
                                    </div><!-- /.copyright -->
                                </div><!-- /.col-md-12 -->
                            </div><!-- /.row -->
                        </div><!-- /.container -->
            ...
            <div>
                <div>
                    <ul>
                        <li><a href="#">Home</a>
                            <ul>
                                <li class="active"><a href="index.html"><i class="fa fa-home"></i> Home Style One</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li><a href="#">Portfolio</a>
                            <ul>
                                ...
                                <li><a href="portfolio-three.html"><i class="fa fa-paper-plane-o"></i> Three Column</a>
                                </li>
                        ...
                        <li><a href="#">Pages</a>
                            <ul>
                                ...
                                <li><a href="typography.html"><i class="fa fa-puzzle-piece"></i> Typography Page</a>
                                </li>
                            </ul>
                        </li>
